...
%%  from ``Proceedings of ...''!
%%
$if(acm-metadata.booktitle)$\acmBooktitle{$acm-metadata.booktitle$}$endif$
...
$if(acm-metadata.submission-id)$\acmSubmissionID{$acm-metadata.submission-id$}$endif$
...
$if(acm-metadata.citestyle)$\citestyle{$acm-metadata.citestyle$}$endif$
